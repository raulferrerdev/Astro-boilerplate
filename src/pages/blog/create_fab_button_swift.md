...
![alt text](/src/images/create_fab_button_swift_1.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_2.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_3.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_4.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_5.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_6.png 'Add FAB Button')
...
![alt text](/src/images/create_fab_button_swift_7.png 'Add FAB Button')

Then we indicate the URL of the Swift package:
![alt text](/src/images/create_fab_button_swift_8.png 'Add FAB Button')

And we indicate the version or branch that we want to add:
![alt text](/src/images/create_fab_button_swift_9.png 'Add FAB Button')

Once added, in the navigation menu we can see the already imported package:
![alt text](/src/images/create_fab_button_swift_10.png 'Add FAB Button')
...
[![](http://img.youtube.com/vi/CitIua96wrc/0.jpg)](http://www.youtube.com/watch?v=CitIua96wrc "")
